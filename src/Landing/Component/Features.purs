module Landing.Component.Features (featuresSection) where

import Prelude

import Alexandrite.StyleX as StyleX
import Data.Maybe (Maybe(..), maybe)
import Landing.Component.Features.JavaScript (javascriptOutputMedia)
import Landing.Component.Features.Performance (performanceMedia)
import Landing.Component.Features.Source (editorIntelligenceMedia, landingPageSource)
